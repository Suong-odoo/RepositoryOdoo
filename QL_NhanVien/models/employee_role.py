...
class EmployeeRole(models.Model):
    ...
    name = fields.Many2one('ql_nhanvien.employee', string="Nhân viên", required=True)
    employee_id = fields.Many2one('ql_nhanvien.employee', string="Mã NV", required=True, options='{"no_open": True}')
